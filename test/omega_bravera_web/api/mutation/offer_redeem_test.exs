defmodule OmegaBraveraWeb.Api.Mutation.OfferRedeemTest do
  ...
  test "can set rewards as redeemed", %{conn: conn, offer_challenge: %{slug: offer_challenge_slug}} do
    response =
      post(conn, "/api", %{query: @claim_online_offer_reward, variables: %{"offerChallengeSlug" => offer_challenge_slug}})
