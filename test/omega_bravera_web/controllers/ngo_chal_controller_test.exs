defmodule OmegaBraveraWeb.NGOChalControllerTest do
  ...
  #    conn = get(conn, Routes.ngo_ngo_chal_path(conn, :new, ngo.slug))
  #
  ...
  #    conn = get(conn, Routes.ngo_ngo_chal_path(conn, :new, "invalid-ngo"))
  #
  ...
  #      ngo = insert(:ngo, %{url: "http://localhost:4000"})
  #      conn = post(conn, Routes.ngo_ngo_chal_path(conn, :create, ngo), ngo_chal: @create_attrs)
  #
  #      assert %{slug: slug} = redirected_params(conn)
  #      assert redirected_to(conn) == Routes.ngo_ngo_chal_path(conn, :show, ngo.slug, slug)
  #
  #      conn = get(conn, Routes.ngo_ngo_chal_path(conn, :show, ngo.slug, slug))
  ...
  #      ngo = insert(:ngo, %{url: "http://localhost:4000"})
  #      conn = post(conn, Routes.ngo_ngo_chal_path(conn, :create, ngo), ngo_chal: @invalid_attrs)
  #      assert html_response(conn, 200) =~ ngo.name
  #    end
  #
  #    @tag :skip
  ...
  #
  #      conn = post(conn, Routes.ngo_ngo_chal_path(conn, :create, ngo), ngo_chal: create_attrs_with_team)
  #
  #      assert %{slug: slug} = redirected_params(conn)
  #      assert redirected_to(conn) == Routes.ngo_ngo_chal_path(conn, :show, ngo.slug, slug)
  #
  ...
  #      conn = get(conn, Routes.ngo_ngo_chal_path(conn, :show, ngo, challenge))
  #
