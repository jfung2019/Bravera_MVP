defmodule OmegaBravera.DevicesTest do
  ...
  describe "devices" do
    ...
    @valid_attrs %{active: true, uuid: "some uuid"}
    @update_attrs %{active: false, uuid: "some updated uuid"}
    @invalid_attrs %{active: nil, uuid: nil}
