defmodule OmegaBravera.Repo.Migrations.MigrateActivities do
  ...
  def up do
    ...
    Repo.update_all(
      from(a in "activities", where: is_nil(a.strava_id) and not is_nil(a.admin_id)),
      set: [manual: true]
    )
    ...
    Repo.update_all(
      from(a in "offer_challenge_activities",
        where: is_nil(a.strava_id) and not is_nil(a.admin_id)
      ),
      set: [manual: true]
    )
    ...
    execute("INSERT INTO ngo_challenge_activities_m2m (id, activity_id, challenge_id)
    ...
    execute("INSERT INTO offer_challenge_activities_m2m (id, activity_id, offer_challenge_id)
  ...
  def down do
    execute("TRUNCATE activities_accumulator CASCADE")
    execute("TRUNCATE ngo_challenge_activities_m2m CASCADE")
    execute("TRUNCATE offer_challenge_activities_m2m CASCADE")
  end
end
