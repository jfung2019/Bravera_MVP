defmodule OmegaBravera.Offers do
  ...
  @doc """
  Returns the list of offer_challenge_teams.

  ## Examples

      iex> list_offer_challenge_teams()
      [%OfferChallengeTeam{}, ...]

  """
  def list_offer_challenge_teams do
    Repo.all(OfferChallengeTeam)
  end

  @doc """
  Gets a single offer_challenge_team.

  Raises `Ecto.NoResultsError` if the Offer challenge team does not exist.

  ## Examples

      iex> get_offer_challenge_team!(123)
      %OfferChallengeTeam{}

      iex> get_offer_challenge_team!(456)
      ** (Ecto.NoResultsError)

  """
  def get_offer_challenge_team!(id), do: Repo.get!(OfferChallengeTeam, id)

  @doc """
  Creates a offer_challenge_team.

  ## Examples

      iex> create_offer_challenge_team(%{field: value})
      {:ok, %OfferChallengeTeam{}}

      iex> create_offer_challenge_team(%{field: bad_value})
      {:error, %Ecto.Changeset{}}
  ...
  @doc """
  Updates a offer_challenge_team.

  ## Examples

      iex> update_offer_challenge_team(offer_challenge_team, %{field: new_value})
      {:ok, %OfferChallengeTeam{}}

      iex> update_offer_challenge_team(offer_challenge_team, %{field: bad_value})
      {:error, %Ecto.Changeset{}}
  ...
  @doc """
  Deletes a OfferChallengeTeam.

  ## Examples

      iex> delete_offer_challenge_team(offer_challenge_team)
      {:ok, %OfferChallengeTeam{}}
  ...
  """
  def delete_offer_challenge_team(%OfferChallengeTeam{} = offer_challenge_team) do
    Repo.delete(offer_challenge_team)
  end

  @doc """
  Returns an `%Ecto.Changeset{}` for tracking offer_challenge_team changes.

  ## Examples

      iex> change_offer_challenge_team(offer_challenge_team)
      %Ecto.Changeset{source: %OfferChallengeTeam{}}
