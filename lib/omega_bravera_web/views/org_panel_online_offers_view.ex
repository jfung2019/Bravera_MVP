defmodule OmegaBraveraWeb.OrgPanelOnlineOffersView do
  ...
  def get_total_redeems_value(offer_redeems) do
    Enum.filter(offer_redeems, fn offer_redeem ->
      not is_nil(offer_redeem.offer_reward_id) and offer_redeem.status == "redeemed" and
        !is_nil(offer_redeem.offer_reward.value)
    end)
