defmodule OmegaBraveraWeb.PrivateChatView do
  ...
  def render("show_message.json", %{
        message: %OmegaBravera.Accounts.PrivateChatMessage{} = message
      }) do
    %{
      id: message.id,
      message: message.message,
      from_user:
        Phoenix.View.render_one(message.from_user, OmegaBraveraWeb.GroupView, "show_user.json",
          as: :user
        ),
      to_user:
        Phoenix.View.render_one(message.to_user, OmegaBraveraWeb.GroupView, "show_user.json",
          as: :user
        ),
      reply_to_message:
